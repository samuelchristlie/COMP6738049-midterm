    ...
    <div class="hero min-h-screen bg-base-200">
      <div class="hero-content text-center">
        ...
        <div class="card bg-base-100 shadow-xl">
          ...
          <div class="card-body">
            <h2 class="card-title"><img src="favicon-32x32.png" alt="Logo" style="transform: translateY(-4px);">Roast House</h2>
            ...
            <form action="/login" method="post">
              <div class="form-control">
                ...
                <button class="btn mt-5 bg-primary text-white">Login</button>
                @isset($error)
            ...
            <a href="register" class="btn bg-neutral">Register an account</a>
